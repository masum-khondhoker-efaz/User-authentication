...
router.post('/register', (0, validateRequest_1.default)(auth_validation_1.authValidation.registerUser), auth_controller_1.AuthControllers.registerUser);
...
router.post('/refresh-token', (0, auth_1.default)(), auth_controller_1.AuthControllers.refreshToken);
